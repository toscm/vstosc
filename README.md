...
- [generateMarkdownReferenceLinks](#generatemarkdownreferencelinks) – Auto-generate
  reference-style links from Markdown headings
...
Automatically generates Markdown reference-style links from all headings in the
active Markdown document and appends or replaces a managed reference section at
the end of the file.
...
The generated reference block is wrapped in HTML comments to indicate it's
autogenerated:
